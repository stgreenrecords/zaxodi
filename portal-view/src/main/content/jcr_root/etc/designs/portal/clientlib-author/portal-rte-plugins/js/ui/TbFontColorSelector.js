 ...
 */
CQ.form.rte.ui.TbFontColorSelector = CQ.Ext.extend(CQ.form.rte.ui.TbElement, {
    ...
    constructor: function(id, plugin, tooltip, styles) {
        CQ.form.rte.ui.TbFontColorSelector.superclass.constructor.call(this, id, plugin, false,
                tooltip);
        this.styles = styles;
    },
    ...
    createStyleOptions: function() {
        ...
        if (this.styles) {
            ...
            for (var s = 0; s < styleCnt; s++) {
                ...
                var valueName = styleToAdd.text.cssName ? styleToAdd.text.cssName : styleToAdd.cssName;
                var className= styleToAdd.cssName;
                var text = styleToAdd.text.text ? styleToAdd.text.text : styleToAdd.text;
                htmlCode += "<option value=\"" + valueName + "\" class=\"" + className + "\">" + text + "</option>";
            }
        }
        return htmlCode;
    },
