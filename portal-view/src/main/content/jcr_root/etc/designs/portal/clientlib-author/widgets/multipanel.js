CQ.wcm.MultiFieldPanel = CQ.Ext.extend(CQ.Ext.Panel, {
    panelValue: '',
    ...
    constructor: function(config){
        ...
        CQ.wcm.MultiFieldPanel.superclass.constructor.call(this, config);
    },

    initComponent: function() {
        CQ.wcm.MultiFieldPanel.superclass.initComponent.call(this);

        var multifield = this.findParentByType('multifield'),
            dialog = this.findParentByType('dialog');

        if(CQ.wcm.MultiFieldPanel.xtype == this.xtype){
    ...
    afterRender : function(){
        CQ.wcm.MultiFieldPanel.superclass.afterRender.call(this);
